...
if __name__ == "__main__":
    ...
    if mode == "predict":
        ...
        capture = cv2.VideoCapture("100lu1cun1500帧.avi")
        ...
        while(True):
            ...
            # 读取某一帧
            ref, frame = capture.read()
            save_frame = np.zeros(frame.shape)
            if not ref:
                break
            # 格式转变，BGRtoRGB
            ...
            # 进行检测
            frame, save_frame, _ = yolo.detect_image(frame)
